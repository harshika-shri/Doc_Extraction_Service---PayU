...
class POLineItemExtractionResult:
    line_items: list[POLineItemExtractionSchema]
    confidence_records: list[ConfidenceRecordPayload]


class POLineItemExtractionService(
    BaseVisionExtractionService,
):
    def extract(
        self,
        file_path: Path,
    ) -> POLineItemExtractionResult:
        ...
        return POLineItemExtractionResult(
    ...
    def _parse_line_items(
        ...
        list[POLineItemExtractionSchema],
    ...
    def _parse_line_item_fields(
        ...
        return {
            ...
            "quantity_ordered": parse_decimal_field(
                raw_item.get(
                    "quantity_ordered",
                ),
            ),
